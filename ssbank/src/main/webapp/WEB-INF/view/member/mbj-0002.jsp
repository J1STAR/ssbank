...
<div class="content">
	...
	<div class="page-con">
			...
			<table class="data-table">
				...
				<tbody>
					...
					<tr>
						<th>주소</th>
						<td>
							<input type="text" id="zip" class="" style="width: 80px;" maxlength="5" readonly="">
							<a href="#" class="btn-type-gray medium" onclick="daumPostcode();">우편번호 찾기</a><br>
							<input type="text" id="addr1" class="" style="width: 100%; margin-top: 8px;">
							<input type="text" id="addr2" class="" style="width: 100%; margin-top: 8px;">
						</td>
					</tr>
					<tr>
						<th>비밀번호</th>
					...
					<tr>
						<th>생년월일</th>
						<td><input type="text" class="" id="date"></td>
					</tr>
					<tr>
						<th>휴대폰</th>
						<td>
		...
		<div class="btn-area">
			...
			<a href="/member/memberJoin" class="btn-type-blue1 big">확인</a>
		</div>
	</div>
	<!-- //jsp body 영역 -->
</div>
