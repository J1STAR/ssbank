...
<script type="text/javascript">
    function sendOk() {
    	...
    	f.action="<%=cp%>/customer/noticeBoard/${mode}";
    ...
    function deleteFile(fileIdx) {
  		var url="<%=cp%>/customer/noticeBoard/deleteFile";
					  ...
					  <table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
					     <tr height="45"> 
					      <td align="center" >
					        ...
					        <a class="btn-type-blue1 medium" onclick="javascript:location.href='<%=cp%>/customer/noticeBoard/noticeList';">${mode=='update'?'수정취소':'등록취소'}</a>
					         <c:if test="${mode=='update'}">
