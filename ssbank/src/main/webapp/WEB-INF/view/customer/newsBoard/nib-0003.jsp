	...
	<c:forEach var="vo" items="${listReply}">
	    ...
	    <tr>
	        ...
	        <td style='padding:7px 5px;' align='right'>
	            <button type='button' class='btn btnReplySendLike' data-replyNum='${vo.replyNum}'>좋아요 <span id='replyLikeCount${vo.replyNum}'>${vo.likeCount}</span></button>
	            <button type='button' class='btn btnReplySendDisLike' data-replyNum='${vo.replyNum}'>싫어요 <span id='replyDisLikeCount${vo.replyNum}'>${vo.disLikeCount}</span></button>
	        </td>
	    </tr>
