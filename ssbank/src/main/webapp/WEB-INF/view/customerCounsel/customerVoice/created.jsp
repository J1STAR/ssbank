...
<br>
	...
	<form name="boardForm">
	  ...
	  <tr align="left" height="40" style="border-bottom: 1px solid #cccccc;"> 
	      ...
	      <td style="padding-left:10px;"> 
	        <input type="hidden" id="categoryIdx" name="categoryIdx" value="10">
	        <input type="text" name="name" id="name" size="35" maxlength="20" class="boxTF" value="${sessionScope.member.userName}" readonly="readonly">
	      </td>
	  </tr>
	  ...
	  <table style="width: 80%; margin: 0px auto; border-spacing: 0px;">
	     <tr height="45"> 
	      <td align="center" >
	      	<div class="btns">
	      		<a class="btn-type-gray" onclick="sendOk('${mode}',${categoryIdx});">${mode=='created'?'등록하기':'수정완료'}</a>
	      		<a class="btn-type-gray" onclick="sendCancel(${categoryIdx},1);">${mode=='created'?'등록취소':'수정취소'}</a>
		  	</div>
		  </td>
	    </tr>
	  </table>
